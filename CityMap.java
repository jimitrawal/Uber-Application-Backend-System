...
public class CityMap
{
  ...
  public static int getCityZone(String address){
    ...
    if (block[1] >= 1 && block[1] <= 5 && block[0] >= 6 && block[0] <= 9){
      return 0;
    }
    else if (block[1] >= 6 && block[1] <= 9 && block[0] >= 6 && block[0] <= 9){
      return 1;
    }
    else if (block[1] >= 6 && block[1] <= 9 && block[0] >= 1 && block[0] <= 5){
      return 2;
    }
    else if (block[1] >= 1 && block[1] <= 5 && block[0] >= 1 && block[0] <= 5){
      return 3;
    }
    else{
      return -1;
